...
#here is the list of valid domains, if required to run program outside of this list add the respective domain to this list#
valid_domains = ['gmail.com', 'getnede.com', 'zohomail.com', 'uwm.edu', 'uic.edu', 'hotmail.com', 'yahoo.com', 'outlook.com',
                'example.com','aol.com', 'protonmail.com', 'icloud.com', 'mail.com', 'yandex.com', 'inbox.com', 'tutanota.com']

#SMTP EMAIL CLIENT CODE#
...
for i in range(len(sys.argv) - 1):
    ...
    try:
        ...
        if recipient_email in valid_domains:
            ...
            print("After Message is sent:" + recv_msg)
            ...
            print("Invalid email domain or recipient")
    except:
